/*
	   Description:  Developed by William Meacham, David Lippman and Frank Marfai in collaboration with Phoenix College and Scottsdale Community College.
...
function FV() {
    ...
    if (validateInput()) {
		...
		accruedVal = accruedVal >= 0 ? Math.floor(accruedVal*10000)/10000 : Math.ceil(accruedVal*10000)/10000;
...
//                  y = Math.pow(1 + rate, bigN);
		...
		principal = principal >= 0 ? Math.floor(principal*10000)/10000 : Math.ceil(principal*10000)/10000;			
...
function PMT() {
    ...
    if (validateInput()) {
        ...
        payment = payment >= 0 ? Math.floor(payment*10000)/10000 : Math.ceil(payment*10000)/10000;
...
//nper_value = Math.log((-fv * rate + pmt)/(pmt + rate * pv))/ Math.log(1 + rate);
        ...
        bigN = bigN >= 0 ? Math.floor(bigN*10000)/10000 : Math.ceil(bigN*10000)/10000;
...
function interest() {
    ...
    if (validateInput()) {
        ...
        interest = interest >= 0 ? Math.floor(interest*10000)/10000 : Math.ceil(interest*10000)/10000;
